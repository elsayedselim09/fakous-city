...
export interface Category {
  ...
  color: string; action_button: string; slug: string
}

export interface Provider {
  id: string; user_id: string; category_id: number; business_name: string
  description?: string; address?: string; village: string; phone?: string
  whatsapp?: string; price_info?: string; working_hours?: string
...
export interface Booking {
  id: string; provider_id: string; citizen_id?: string; citizen_name: string
  citizen_phone: string; booking_date: string; booking_time: string
  notes?: string; status: BookingStatus; created_at: string
...
export interface SearchFilters {
  query?: string; category_slug?: string; village?: string
  is_available?: boolean; min_rating?: number
  sort_by?: 'rating' | 'reviews' | 'newest'; page?: number
}
